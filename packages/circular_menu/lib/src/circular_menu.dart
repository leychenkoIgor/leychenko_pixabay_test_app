...
class CircularMenu extends StatefulWidget {
  ...
  final Function? animatedIconCall;
...
class CircularMenuState extends State<CircularMenu>
  ...
  Widget _buildMenuButton(BuildContext context) {
    // Widget wg = Icon(key: ValueKey<int>(1), Icons.ac_unit_rounded);
    return Positioned.fill(
      child: Align(
        ...
        child: CircularMenuItem(
          ...
          // (-_animation.value * widget.toggleButtonPadding * 0.5) +
          //     widget.toggleButtonPadding,
          onTap: () {
            if (_animationController.status == AnimationStatus.dismissed) {
              // wg = Icon(key: ValueKey<int>(2), Icons.access_alarms);
              (_animationController).forward();
            } else {
              // wg = Icon(key: ValueKey<int>(1), Icons.ac_unit_rounded);
              (_animationController).reverse();
            }
          ...
          animatedIcon: widget.animatedIconCall != null
              ? widget.animatedIconCall!(_animationController)
              : AnimatedIcon(
                  icon: widget
